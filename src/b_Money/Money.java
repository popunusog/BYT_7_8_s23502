...
public class Money implements Comparable<Money> {
	...
	public Boolean equals(Money other) {
		...
		return this.getAmount().equals(other.getAmount()) && this.getCurrency().equals(other.getCurrency());
	}
	...
	public Money add(Money other) {
		int otherValueInThisCurrency = currency.valueInThisCurrency(other.getAmount(), other.getCurrency());
		return new Money(this.amount + otherValueInThisCurrency, this.currency);
	}
	...
	public int compareTo(Money other) {
		return Integer.compare(this.universalValue(), other.universalValue());
	}
}
